...
import { Bars3Icon, CodeBracketSquareIcon } from "@heroicons/react/24/outline";
...
export const menuLinks: HeaderMenuLink[] = [
  ...
  {
    label: "Github Repo",
    href: "https://github.com/ritiklakhwani/zk-credit-score-eth-global-bangkok",
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6 shrink-0">
          ...
          <div className="flex items-center">
              <a href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                ...
                <span className="text-xl font-bold gradient-text">ZK Credit Score</span>
              </a>
            </div>
          </div>
        </Link>
